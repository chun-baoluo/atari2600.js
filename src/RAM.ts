...
export class RAM {
	...
	private static switchRom(id: number): void {
	...
	public static read(address: number): number {
	...
	public static readRom(banks: Array<Uint8Array>, type: string): void {
		this.banks = banks;
	...
	public static set(address: number, value: number): number {
		this.memory[address] = value;

		return this.memory[address];
	};

	public static write(address: number, value: number): number {
		if(this[address] !== undefined) {
	...
	// VSYNC write
	// CXM0P read
	private static 0x00(value: number): number {
	...
	// CXM1P read
	private static 0x01(): number {
		return this.memory[0x31];
	};

	// WSYNC write
	// CXP0FB read
	private static 0x02(value: number): number {
	...
	// CXP1FB read
	private static 0x03(): number {
		return this.memory[0x33];
	};

	// NUSIZ0 write
	// CXM0FB read
	private static 0x04(value: number): number {
	...
	// NUSIZ1 write
	// CXM1FB read
	private static 0x05(value: number): number {
	...
	// COLUP0 write
	// CXBLPF read
	private static 0x06(value: number): number {
	...
	// COLUP1 write
	// CXPPMM read
	private static 0x07(value: number): number {
	...
	// COLUPF write
	// INPT0 read
	private static 0x08(value: number): number {
	...
	// COLUBK write
	// INPT1 read
	private static 0x09(value: number): number {
	...
	// CTRLPF write
	// INPT2 read
	private static 0x0A(value: number): number {
	...
	// REFP0 write
	// INPT3 read
	private static 0x0B(value: number): number {
	...
	// REFP1 write
	// INPT4 read
	private static 0x0C(value: number): number {
	...
	// PF0 write
	// INPT5 read
	private static 0x0D(value: number): number {
	...
	// PF1 write
	private static 0x0E(value: number): number {
	...
	// PF2 write
	private static 0x0F(value: number): number {
	...
	// RESP0 write
	private static 0x10(value: number): number {
	...
	// RESP1 write
	private static 0x11(value: number): number {
	...
	// RESM0 write
	private static 0x12(value: number): number {
	...
	// RESM1 write
	private static 0x13(value: number): number {
	...
	// RESBL write
	private static 0x14(value: number): number {
	...
	// GRP0 write
	private static 0x1B(value: number): number {
	...
	// GRP1 write
	private static 0x1C(value: number): number {
	...
	// ENAM0 write
	private static 0x1D(value: number): number {
	...
	// ENAM1 write
	private static 0x1E(value: number): number {
	...
	// ENABL write
	private static 0x1F(value: number): number {
	...
	// HMP0 write
	private static 0x20(value: number): number {
	...
	// HMP1 write
	private static 0x21(value: number): number {
	...
	// HMM0 write
	private static 0x22(value: number): number {
	...
	// HMM1 write
	private static 0x23(value: number): number {
	...
	// HMBL write
	private static 0x24(value: number): number {
	...
	// VDELP0 write
	private static 0x25(value: number): number {
	...
	// VDELP1 write
	private static 0x26(value: number): number {
	...
	// VDELBL write
	private static 0x27(value: number): number {
	...
	// HMOVE write
	private static 0x2A(value: number): number {
	...
	// HMCLR write
	private static 0x2B(value: number): number {
	...
	// CXCLR write
	private static 0x2C(value: number): number {
	...
	// CXM0P read only
	private static 0x30(): number {
		return this.memory[0x30];
	};

	// CXM1P read only
	private static 0x31(): number {
		return this.memory[0x31];
	};

	// CXP0FB read only
	private static 0x32(): number {
		return this.memory[0x32];
	};

	// CXP1FB read only
	private static 0x33(): number {
		return this.memory[0x33];
	};

	// CXM0FB read only
	private static 0x34(): number {
		return this.memory[0x34];
	};

	// CXM1FB read only
	private static 0x35(): number {
		return this.memory[0x35];
	};

	// CXBLPF read only
	private static 0x36(): number {
		return this.memory[0x36];
	};

	// CXPPMM read only
	private static 0x37(): number {
		return this.memory[0x37];
	};

	// INPT0 read only
	private static 0x38(): number {
		return this.memory[0x38];
	};

	// INPT1 read only
	private static 0x39(): number {
		return this.memory[0x39];
	};

	// INPT2 read only
	private static 0x3A(): number {
		return this.memory[0x3A];
	};

	// INPT3 read only
	private static 0x3B(): number {
		return this.memory[0x3B];
	};

	// INPT4 read only
	private static 0x3C(): number {
		return this.memory[0x3C];
	};

	// INPT5 read only
	private static 0x3D(): number {
		return this.memory[0x3D];
	};

	// SWCHA read/write
	private static 0x280(value: number): number {
		if(value) {
			this.swchaW = value;
			return value;
		};
	...
	// SWCHB read/write
	private static 0x282(value: number): number {
		if(value) {
			this.swchbW = value;
			return value;
		};
	...
	// TIM1T write
	private static 0x294(value: number): number {
	...
	// TIM8T write
	private static 0x295(value: number): number {
	...
	// TIM64T write
	private static 0x296(value: number): number {
	...
	// TIM1024T write
	private static 0x297(value: number): number {
	...
	private static 0xFFF4(value: number): number {
		switch(this.type) {
			case '32KB':
				this.switchRom(0);
				break;
	...
	private static 0xFFF5(value: number): number {
		switch(this.type) {
			case '32KB':
				this.switchRom(1);
				break;
	...
	private static 0xFFF6(value: number): number {
		switch(this.type) {
			case '16KB':
				this.switchRom(0);
				break;
	...
	private static 0xFFF7(value: number): number {
		switch(this.type) {
			case '16KB':
				this.switchRom(1);
				break;
	...
	private static 0xFFF8(value: number): number {
		switch(this.type) {
			case '8KB':
				this.switchRom(0);
				break;
	...
	private static 0xFFF9(value: number): number {
		switch(this.type) {
			case '8KB':
				this.switchRom(1);
				break;
	...
	private static 0xFFFA(value: number): number {
		switch(this.type) {
			case '12KB':
				this.switchRom(2);
				break;
	...
	private static 0xFFFB(value: number): number {
		switch(this.type) {
			case '32KB':
				this.switchRom(7);
				break;
