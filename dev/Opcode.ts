...
export class Opcode {
    ...
    public static 0x19() {
        ...
        return 4 + (this.isNextPage(address, address + Register.Y) ? 1 : 0);
    };
    ...
    public static 0x5D() {
        ...
        this.EOR(RAM.read(address + Register.X));
    ...
    public static 0xF9() {
        ...
        this.ADC(Convert.toUint8(~RAM.read(address + Register.Y)));
